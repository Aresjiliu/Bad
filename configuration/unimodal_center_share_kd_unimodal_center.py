...
parser.add_argument('--train_epoch', type=int, default=200), parser.add_argument('--batch_size', type=int, default=32)
...
parser.add_argument('--lambda_center_loss', type=float, default=1.0)
...
parser.add_argument('teacher_model', type=str, default='quanti/Huston_teacher_ms.pth')
parser.add_argument('model_saved', type=str, default='unknown')
parser.add_argument('--gpu', type=int, default=1)
parser.add_argument('--version', type=int, default=0)
parser.add_argument('--lambda_kd_feature', type=float, default=30.0, help='trade-off parameter for kd loss')
parser.add_argument('--location', type=str, default='after')
parser.add_argument('-q', '--quantize', default='DSQ', type=str, help='quantization type.')
...
args.data_root = '/data1/yco/TGRS-DGDNet/data/' + args.data_root
args.pair_modalities = args.teacher_data.split('+')
args.name = args.method + "_" + args.teacher_data + "_lr_" + str(args.lr) + '_version_' + str(
    args.version) + "_lambda_kd_feature_" + str(args.lambda_kd_feature) + "_lambda_center_loss_" + str(
    args.lambda_center_loss)
