...
parser.add_argument('--load_root', type=str, default='hsi_lidar_osc_0.3_l1_0.0001_gama_1.003.pth')
...
parser.add_argument('--osc', type=float, default=1.0)
parser.add_argument('--t_max', type=float, default=2.0)
parser.add_argument('--temp_epoch', type=int, default=5)
...
args.load_root = '../output/models/prune_huston_repair/'+args.load_root
os.environ['CUDA_VISIBLE_DEVICES'] = str(args.gpu)
args.name = args.pair_modalities[0] + "_" + args.pair_modalities[1]+"_osc_"+str(args.osc)+"_l1_"+str(args.l1_loss)+"_gama_"+str(args.gama)
