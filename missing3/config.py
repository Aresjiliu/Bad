...
parser.add_argument('--lambda0', type=float, default=0.8)  # 降低共享特征损失权重
parser.add_argument('--lambda1', type=float, default=0.3)  # 降低特定-共享距离约束权重
parser.add_argument('--lambda2', type=float, default=0.2)  # 降低特定特征间约束权重
parser.add_argument('--lidar_lambda', type=float, default=0.8)  # 平衡LiDAR模态影响
