...
class HSI_Lidar_Couple_Share(nn.Module):
    ...
    def forward(self, hsi, lidar):
        ...
        return x, feature, self.p, x_hsi_out, x_lidar_out



class HSI_Lidar_Couple_Dymic(nn.Module):
    def __init__(self, args, modality_1_channel, modality_2_channel, dymic_channel):
        super().__init__()
        self.special_bone_hsi = Couple_CNN_Dymic(modality_1_channel, dymic_channel[:3])
        self.special_bone_lidar = Couple_CNN_Dymic(modality_2_channel, dymic_channel[3:6])
        self.share_bone = MDMB_fusion_Dymic(dymic_channel[2]+dymic_channel[5], dymic_channel[6:], args)
        self.p = args.p
        self.args = args
...
class HSI_Lidar_Couple_Dymic_Sinput(nn.Module):
    def __init__(self, args, modality_1_channel, modality_2_channel, dymic_channel):
        super().__init__()
        self.special_bone_hsi = Couple_CNN_Dymic(modality_1_channel, dymic_channel[:3])
        self.special_bone_lidar = Couple_CNN_Dymic(modality_2_channel, dymic_channel[3:6])
...
class HSI_Lidar_Couple_sinput(nn.Module):
    def __init__(self, args, modality_1_channel, modality_2_channel):
        super().__init__()
...
class HSI_Lidar_Couple_Share_FM(nn.Module):
    def __init__(self, args, modality_1_channel, modality_2_channel):
        super().__init__()

        self.special_bone_hsi = Couple_CNN_FM(input_channel=modality_1_channel)
        self.special_bone_lidar = Couple_CNN_FM(input_channel=modality_2_channel)
        self.share_bone = MDMB_fusion_share_FM(256, args)
        self.p = args.p
        self.args = args
