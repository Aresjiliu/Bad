...
sys.path.append('..')
from models.surf_mmfomer import HSI_Lidar_Couple_Former
from src.huston2013_dataloader import huston2013_multi_dataloader
from configuration.mmformer import args
import torch
import torch.nn as nn
from lib.model_develop import train_base_multi_mmformer
...
def deeppix_main(args):
    ...
    if 1 not  in args.p:
        args.model_root = args.model_root + "/mmformer_drop"
        args.log_root = args.log_root + "/mmformer_drop"
    else:
        args.model_root=args.model_root+"/mmformer_full"
        args.log_root=args.log_root+"/mmformer_full"
    ...
    args.retrain = False
    train_base_multi_mmformer(model=model, cost=criterion, optimizer=optimizer, train_loader=train_loader,
