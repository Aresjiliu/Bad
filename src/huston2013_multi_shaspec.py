...
def deeppix_main(args):
    ...
    if 1 not in args.p:
        args.model_root = args.model_root + "/shaspec_drop"
        args.log_root = args.log_root + "/shaspec_drop"
    else:
        args.model_root = args.model_root + "/shaspec_full"
        args.log_root = args.log_root + "/shaspec_full"
