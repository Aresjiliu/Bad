...
sys.path.append('..')
from models.resnet_ensemble import HSI_Lidar_Couple_Prune
...
def deeppix_main(args):
    ...
    args.model_root = args.model_root + "/prune_berlin_succ"
    args.log_root = args.log_root + "/prune_berlin_succ"
    ...
    args.retrain = False
    train_base_multi_share_unimodal_center_prune(model=model, cost=criterion, optimizer=optimizer,
