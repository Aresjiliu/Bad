...
from lib.model_develop import train_base_multi_share_unimodal_center
...
def deeppix_main(args):
    ...
    if 1 not in args.p:
        args.model_root = args.model_root + "/share_unimodel_center_drop"
        args.log_root = args.log_root + "/share_unimodel_center_drop"
    else:
        args.model_root = args.model_root + "/share_unimodal_center_full"
        args.log_root = args.log_root + "/share_unimodal_center_full"
    ...
    args.retrain = False
    train_base_multi_share_unimodal_center(model=model, cost=criterion, optimizer=optimizer, train_loader=train_loader,
